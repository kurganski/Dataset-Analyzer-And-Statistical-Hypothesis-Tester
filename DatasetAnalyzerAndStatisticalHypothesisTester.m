...
try
    h = waitbar(0,'Идет загрузка данных','WindowStyle','modal'); 
    ...
    errordlg({'Невозможно прочитать данные.';...
        'Убедитесь, что файлы имеют расширения "xlsx", "xls" или "csv",';...
        'а данные представленны в виде двухмерной таблицы без вложенных столбцов'},...
